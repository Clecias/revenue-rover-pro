      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-success p-6 rounded-xl mb-8">
          <div className="flex items-start gap-4">
            <Shield className="w-10 h-10 flex-shrink-0 mt-1 text-success-foreground" />
            <div className="text-left">
              <p className="font-bold text-xl mb-2 text-success-foreground">🛡️ Garantia Incondicional de 30 Dias</p>
              <p className="text-lg text-success-foreground">Use o sistema por 30 dias completos. Se ele não recuperar mais dinheiro do que o valor da mensalidade, você recebe 100% do seu investimento de volta. Sem perguntas, sem burocracia. O risco é TODO meu.</p>
            </div>
          </div>
        </div>
